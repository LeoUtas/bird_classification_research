...
# _______ MOBILENET TEST14_2: RE-TRAIN THE LAST 15 LAYERS _______ #
start_time = time()
...
# assign the last 15 layers to be trainable
last_35_layers = model_base.layers[-35:]
for layer in last_35_layers:
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        "save_best_models/best_model_mobilenet_TEST14_2.h5",  # path to save the best model
...
mobilenet_TEST14_2_train_accuracy = history.history["accuracy"]
mobilenet_TEST14_2_val_accuracy = history.history["val_accuracy"]
mobilenet_TEST14_2_train_loss = history.history["loss"]
mobilenet_TEST14_2_val_loss = history.history["val_loss"]

# load the saved best model
best_model_0 = tf.keras.models.load_model(
    "save_best_models/best_model_mobilenet_TEST14_2.h5"
)

# evaluate the test data using the loaded best model
mobilenet_TEST14_2_test_loss, mobilenet_TEST14_2_test_accuracy = best_model_0.evaluate(
    test_data
)

end_time = time()
execution_time_TEST14_2 = end_time - start_time

logging.info("mobilenet TEST14_2 was done")
# --------------------------------------------------------------------------------------- #
...
metrics = {
    "MobileNet_TEST14_2": {
        "train_accuracy": mobilenet_TEST14_2_train_accuracy,
        "val_accuracy": mobilenet_TEST14_2_val_accuracy,
        "train_loss": mobilenet_TEST14_2_train_loss,
        "val_loss": mobilenet_TEST14_2_val_loss,
        "test_accuracy": mobilenet_TEST14_2_test_accuracy,
        "test_loss": mobilenet_TEST14_2_test_loss,
        "execution_time": execution_time_TEST14_2,
    },
}


# ________________ SAVE MODEL PERFORMANCE LOG TO .JSON ________________ #
test_name = "mobilenet_finetune6"
