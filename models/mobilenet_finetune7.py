...
# _______ MOBILENET test16_2: RE-TRAIN THE LAST 5 LAYERS _______ #
start_time = time()
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        "save_best_models/best_model_mobilenet_test16_2.h5",  # path to save the best model
...
mobilenet_test16_2_train_accuracy = history.history["accuracy"]
mobilenet_test16_2_val_accuracy = history.history["val_accuracy"]
mobilenet_test16_2_train_loss = history.history["loss"]
mobilenet_test16_2_val_loss = history.history["val_loss"]
# mobilenet_test16_2_test_loss, mobilenet_test16_2_test_accuracy = model_0.evaluate(test_data)

# load the saved best model
best_model_0 = tf.keras.models.load_model(
    "save_best_models/best_model_mobilenet_test16_2.h5"
)

# evaluate the test data using the loaded best model
mobilenet_test16_2_test_loss, mobilenet_test16_2_test_accuracy = best_model_0.evaluate(
    test_data
)

model_0.save("save_best_models/best_model_mobilenet_test16_2.h5")

end_time = time()
execution_time_test16_2 = end_time - start_time

logging.info("mobilenet test16_2 was done")
# --------------------------------------------------------------------------------------- #
...
metrics = {
    "MobileNet_test16_2": {
        "train_accuracy": mobilenet_test16_2_train_accuracy,
        "val_accuracy": mobilenet_test16_2_val_accuracy,
        "train_loss": mobilenet_test16_2_train_loss,
        "val_loss": mobilenet_test16_2_val_loss,
        "test_accuracy": mobilenet_test16_2_test_accuracy,
        "test_loss": mobilenet_test16_2_test_loss,
        "execution_time": execution_time_test16_2,
    },
}


# ________________ SAVE MODEL PERFORMANCE LOG TO .JSON ________________ #
test_name = "mobilenet_finetune7"
