...
# _______ MOBILENETV2 TEST9: RE-TRAIN THE WHOLE MODEL & AUGMENTATION _______ #
start_time = time()
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        "save_best_models/best_model_mobilenetv2_test9.h5",  # path to save the best model
...
mobilenetv2_test9_train_accuracy = history.history["accuracy"]
mobilenetv2_test9_val_accuracy = history.history["val_accuracy"]
mobilenetv2_test9_train_loss = history.history["loss"]
mobilenetv2_test9_val_loss = history.history["val_loss"]

# load the saved best model
best_model_0 = tf.keras.models.load_model(
    "save_best_models/best_model_mobilenetv2_test9.h5"
)

# evaluate the test data using the loaded best model
mobilenetv2_test9_test_loss, mobilenetv2_test9_test_accuracy = best_model_0.evaluate(
    test_data
)
...
logging.info("mobilenetv2 test9 was done")
# --------------------------------------------------------------------------------------- #
...
metrics = {
    "mobilenetv2_test9": {
        "train_accuracy": mobilenetv2_test9_train_accuracy,
        "val_accuracy": mobilenetv2_test9_val_accuracy,
        "train_loss": mobilenetv2_test9_train_loss,
        "val_loss": mobilenetv2_test9_val_loss,
        "test_accuracy": mobilenetv2_test9_test_accuracy,
        "test_loss": mobilenetv2_test9_test_loss,
...
test_name = "mobilenetv2_finetune4"
