...
# _______ INCEPTIONV3 test2: RE-TRAIN THE LAST 120 LAYERS _______ #
start_time = time()
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        "save_best_models/best_model_inceptionV3_test2.h5",  # path to save the best model
...
inceptionV3_test2_train_accuracy = history.history["accuracy"]
inceptionV3_test2_val_accuracy = history.history["val_accuracy"]
inceptionV3_test2_train_loss = history.history["loss"]
inceptionV3_test2_val_loss = history.history["val_loss"]

# load the saved best model
best_model_0 = tf.keras.models.load_model(
    "save_best_models/best_model_inceptionV3_test2.h5"
)

# evaluate the test data using the loaded best model
inceptionV3_test2_test_loss, inceptionV3_test2_test_accuracy = best_model_0.evaluate(
    test_data
)
...
logging.info("InceptionV3 test2 was done")
# --------------------------------------------------------------------------------------- #


# _______ INCEPTIONV3 test3: RE-TRAIN THE LAST 120 LAYERS & AUGMENTATION _______ #
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        "save_best_models/best_model_inceptionV3_test3.h5",  # path to save the best model
        monitor="val_accuracy",
        save_best_only=True,  # only save the best model based on `monitor`
        verbose=1,  # print a message whenever a new best model is saved
        mode="max",  # since we're monitoring accuracy, we want to maximize it
...
inceptionV3_test3_train_accuracy = history.history["accuracy"]
inceptionV3_test3_val_accuracy = history.history["val_accuracy"]
inceptionV3_test3_train_loss = history.history["loss"]
inceptionV3_test3_val_loss = history.history["val_loss"]

# load the saved best model
best_model_0 = tf.keras.models.load_model(
    "save_best_models/best_model_inceptionV3_test3.h5"
)

# evaluate the test data using the loaded best model
inceptionV3_test3_test_loss, inceptionV3_test3_test_accuracy = best_model_0.evaluate(
    test_data
)
...
logging.info("InceptionV3 test3 was done")
# --------------------------------------------------------------------------------------- #

# _______ RECORD ALL RESULTS _______ #
metrics = {
    "InceptionV3_test2": {
        "train_accuracy": inceptionV3_test2_train_accuracy,
        "val_accuracy": inceptionV3_test2_val_accuracy,
        "train_loss": inceptionV3_test2_train_loss,
        "val_loss": inceptionV3_test2_val_loss,
        "test_accuracy": inceptionV3_test2_test_accuracy,
        "test_loss": inceptionV3_test2_test_loss,
        "execution_time": execution_time_test2,
    },
    "inceptionV3_test3": {
        "train_accuracy": inceptionV3_test3_train_accuracy,
        "val_accuracy": inceptionV3_test3_val_accuracy,
        "train_loss": inceptionV3_test3_train_loss,
        "val_loss": inceptionV3_test3_val_loss,
        "test_accuracy": inceptionV3_test3_test_accuracy,
        "test_loss": inceptionV3_test3_test_loss,
...
test_name = "InceptionV3_finetune1"
